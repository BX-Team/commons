...
- **Adventure API integration** (commons-adventure)
...
- [Adventure API](https://github.com/KyoriPowered/adventure) - Modern Minecraft text API
...
Special thanks to [EternalCodeTeam](https://github.com/EternalCodeTeam) for their commons library, which provided inspiration for several features in this project.
